...
describe SeasonsController do
  ...
  let(:valid_attributes) { { "period" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved season as @season" do
        ...
        post :create, {:season => { "period" => "invalid value" }}, valid_session
        assigns(:season).should be_a_new(Season)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested season" do
        ...
        Season.any_instance.should_receive(:update).with({ "period" => "MyString" })
        put :update, {:id => season.to_param, :season => { "period" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the season as @season" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Season.any_instance.stub(:save).and_return(false)
        put :update, {:id => season.to_param, :season => { "period" => "invalid value" }}, valid_session
        assigns(:season).should eq(season)
      end
